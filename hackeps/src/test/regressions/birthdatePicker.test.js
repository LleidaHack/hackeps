...
test("selects leap day in ISO format and restores trigger focus", () => {
...
test("does not offer an invalid leap day and Escape cancels without changing the date", () => {
  const onChange = jest.fn();
  render(
    <BirthdatePicker
      value="2001-02-20"
  ...
  fireEvent.keyDown(screen.getByLabelText("Mes de naixement"), {
    key: "Escape",
  });
