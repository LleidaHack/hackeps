...
const LaunchFooter = () => {
  return (
    <footer
      data-testid="launchFooterHackeps"
      className="w-full bg-[#78C6BD] flex flex-col items-center justify-center px-4 pt-6 md:pt-10 pb-6 md:pb-10 font-space-mono"
    >
      ...
      <div className="flex flex-col items-center gap-2 md:gap-4 text-[10px] md:text-xs font-bold text-gray-800 underline decoration-1 underline-offset-4 mb-4 text-center">
        <a href={ROUTES.terms} className="text-black" target="_blank" rel="noreferrer">Termes i Condicions</a>
        <a href={ROUTES.privacy} className="text-black" target="_blank" rel="noreferrer">Politica de Privadesa de LleidaHack</a>
