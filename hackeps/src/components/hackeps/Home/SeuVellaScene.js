...
export default function SeuVellaScene() {
  return (
    ...
    >
      <image href={firework} x="100" y="120" width="250" height="250" />
      <path fill="#36b39d" d="M0 365 Q420 420 1200 510 V620 H0Z" />
      <g fill="#36b39d" transform="translate(95 215)">
      ...
      <g fill="#78c6bd" transform="translate(350 215) scale(1.35)">
        <path d="M39 85 L34 190 H62 L57 85Z" />
        <path d="M14 115 C-16 112 -12 73 12 68 C7 37 28 19 46 31 C57 -7 95 14 88 42 C120 38 127 65 113 79 C147 100 121 126 101 119Z" />
      </g>
      <image href={seuVella} x="585" y="30" width="500" height="505" />
      <path fill="#78c6bd" d="M0 505 Q560 395 1200 530 V620 H0Z" />
    </svg>
  );
}
