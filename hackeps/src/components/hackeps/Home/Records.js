  ...
  return (
    ...
    >
      ...
      <img
        ...
        width={435}
        height={219}
        className="ambient-cloud ambient-cloud--2 ambient-cloud--left pointer-events-none absolute right-[-8%] bottom-[8%] z-0 hidden h-auto w-[28%] max-w-[320px] object-contain opacity-80 lg:block"
      />
