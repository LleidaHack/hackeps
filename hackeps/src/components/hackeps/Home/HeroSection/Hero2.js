      ...
      <div className="bg-blueSea w-full h-[110vh] flex flex-row">
          ...
          <div className="opacity-0" ref={logoHackeps2025}>
            ...
            <div className="absolute top-[65%] left-[28%] z-50">
              <Button
                ...
                className={
                  "bg-red-500 text-white hover:bg-primaryHackeps duration-1 cursor-pointer"
                }
                outline
              >
                Descobreix més
        ...
        <div className="col2 flex flex-row justify-end items-center align-middle w-1/3">
          <img
            src={burbujas}
            alt="Burbujas"
            className="w-28 transform translate-y-[80vh]"
            ref={bubble1}
          />
          <img
            src={burbujas}
        ...
        <div className="col3 flex flex-row ancla w-1/3">
          <img
            src={anclaCadena}
            ref={cadena}
            className={`w-3/12 absolute bottom-0 left-[80%] transform -translate-y-[80%] ${!ensureAnimations ? "hidden" : "block"}`}
            alt="ancla"
          />
          <img
            src={sirena}
            ref={sirenaPiedra}
            className="w-2/12 absolute bottom-0 left-[84%] transform translate-y-[70%]"
            alt="sirena"
          />
        </div>
      </div>
