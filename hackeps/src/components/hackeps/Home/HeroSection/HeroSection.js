    ...
    <div className="relative w-full overflow-hidden" style={{ backgroundColor: sky }}>
      <div className="relative w-full pb-8 pt-2 md:pb-12 md:pt-4" style={{ backgroundColor: sky }}>
        ...
        <img
          ...
          width={425}
          height={214}
          className="ambient-cloud ambient-cloud--1 pointer-events-none absolute right-[4%] top-[22%] z-[5] hidden h-auto w-[28%] max-w-[320px] object-contain md:block"
        />
        <img
          src={cloud2}
          alt=""
          ...
          width={435}
          height={219}
          className="ambient-cloud ambient-cloud--2 pointer-events-none absolute bottom-[14%] left-[6%] z-[5] hidden h-auto w-[30%] max-w-[340px] object-contain lg:block"
        />
        <img
          src={cloud3}
          alt=""
          ...
          width={368}
          height={163}
          className="ambient-cloud ambient-cloud--0 pointer-events-none absolute bottom-[4%] right-[4%] z-[5] hidden h-auto w-[24%] max-w-[280px] object-contain lg:block"
        />
